...
{
    public interface IJobRepository : IRepository<JobVacancy>, IGetAll<JobVacancy>, IGetAllById<JobVacancy>, IGetJobByTitle<JobVacancy>, IGetJobByModality<JobVacancy>
    {
